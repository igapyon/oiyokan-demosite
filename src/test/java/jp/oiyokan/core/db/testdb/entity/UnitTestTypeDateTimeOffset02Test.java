 ...
 * 後方空白が適切な状態での挙動確認。
 */
class UnitTestTypeDateTimeOffset02Test {
    @SuppressWarnings("unused")
    private static final Log log = LogFactory.getLog(UnitTestTypeDateTimeOffset02Test.class);
    ...
    void test03() throws Exception {
        ...
        // log.info(result);
        assertEquals("\"" + "2020-12-31T12:53:00Z" + "\"", dateString, "格納した DateTimeOffset型が同値で取得できること。");
