CREATE TABLE
  ODataTest1 (
    ...
    , StringLongVar1 VARCHAR(1024) DEFAULT 'LONGVARCHAR'
    , Clob1 TEXT DEFAULT 'CLOB'
    , Boolean1 BIT DEFAULT 0
    , Single1 REAL DEFAULT 123.45
    , Double1 FLOAT(53) DEFAULT 123.4567890123
    , Date1 DATE DEFAULT CURRENT_TIMESTAMP
    , DateTimeOffset1 DATETIME2 DEFAULT CURRENT_TIMESTAMP
    , TimeOfDay1 TIME DEFAULT '00:00:00'
    , Binary1 BINARY(128) DEFAULT 0x48656c6c6f20776f726c6421
    , VarBinary1 VARBINARY(128) DEFAULT 0x48656c6c6f20776f726c6421
    , LongVarBinary1 VARBINARY(8000) DEFAULT 0x48656c6c6f20776f726c6421
    , Blob1 VARBINARY(8000) DEFAULT 0x48656c6c6f20776f726c6421
    , PRIMARY KEY(ID)
  );
...
CREATE TABLE
  ODataTest3 (
    ...
    , StringLongVar1 VARCHAR(1024) DEFAULT 'LONGVARCHAR'
    , Clob1 TEXT DEFAULT 'CLOB'
    , Boolean1 BIT DEFAULT 0 NOT NULL
    , Single1 REAL DEFAULT 123.45
    , Double1 FLOAT(53) DEFAULT 123.4567890123
    , Date1 DATE DEFAULT CURRENT_TIMESTAMP NOT NULL
    , DateTimeOffset1 DATETIME2 DEFAULT CURRENT_TIMESTAMP NOT NULL
    , TimeOfDay1 TIME DEFAULT '00:00:00'
    , Binary1 BINARY(128) DEFAULT 0x48656c6c6f20776f726c6421
    , VarBinary1 VARBINARY(128) DEFAULT 0x48656c6c6f20776f726c6421
    , LongVarBinary1 VARBINARY(8000) DEFAULT 0x48656c6c6f20776f726c6421
...
CREATE TABLE
  ODataTest5 (
    Iden1 INT IDENTITY(1,1) NOT NULL
...
CREATE TABLE
  ODataTest7 (
    ...
    , Uuid1 UNIQUEIDENTIFIER DEFAULT NEWID()
    , PRIMARY KEY(ID)
  );
